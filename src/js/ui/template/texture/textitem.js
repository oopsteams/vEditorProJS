export default ({ uid, locale, cellStyle, rowStyle, cssPrefix, svgStyle, subStyle }) => `
      ...
      <div class="${cssPrefix}-media-row subrow" uid="${uid}">
        <div class="${cssPrefix}-media-cell" style="${cellStyle}">
          <div class="${cssPrefix}-media-cell-h">
            ...
            <input class="${cssPrefix}-media-range-value ${cssPrefix}-range-value" value="10" uid="${uid}"/>
          </div>
        </div>
      </div>
      <div class="${cssPrefix}-media-row subrow" uid="${uid}">
        <div class="${cssPrefix}-media-cell" style="${cellStyle}">
          <div class="${cssPrefix}-media-cell-h">
            <span class="range ${cssPrefix}-media-label">${locale.localize('Rotation')}</span>
            <div class="rotation-range ${cssPrefix}-range"></div>
            <input class="${cssPrefix}-rotation-range-value ${cssPrefix}-range-value" value="0" uid="${uid}"/>
          </div>
        </div>
      </div>
      <div class="${cssPrefix}-media-row subrow" uid="${uid}">
        <div class="${cssPrefix}-media-cell" style="${cellStyle}">
          <div class="${cssPrefix}-media-cell-h">
            <span class="range ${cssPrefix}-media-label">${locale.localize('Opacity')}</span>
            <div class="opacity-range ${cssPrefix}-range"></div>
            <input class="${cssPrefix}-opacity-range-value ${cssPrefix}-range-value" value="0" uid="${uid}"/>
          </div>
        </div>
      </div>
      <div class="${cssPrefix}-media-row subrow" uid="${uid}">
        <div class="${cssPrefix}-media-cell" style="${cellStyle}">
          <div class="${cssPrefix}-media-cell-table celltable animation">
          </div>
        </div>
      </div>
      <div class="${cssPrefix}-media-row subrow" uid="${uid}">
