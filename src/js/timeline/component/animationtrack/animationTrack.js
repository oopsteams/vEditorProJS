...
import AnimationTrackItem from './animationTrackItem';
import AnimationSlipWindow from './slipwin';
import BaseTrack from '../base/baseTrack';

// import { eventNames } from '@/consts';
const TrackItem = AnimationTrackItem;
const SlipWindow = AnimationSlipWindow;

class AnimationTrack extends BaseTrack {
