...
import { styleLoad, cssPrefix } from '@/util';
...
class Theme {
   ...
   */
  _loadDefaultSvgIcon() {
    // const tag = 'tui-image-editor-svg-default-icons';
    const tag = 've-pro-svg-default-icons';
  ...
  _makeIconClassName(iconType, isSubmenu) {
    ...
    // console.log(`_makeIconClassName, path:${path}, name:${name}`);
