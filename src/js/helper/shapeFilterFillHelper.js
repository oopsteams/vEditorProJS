...
export function resetFillPatternCanvas(patternSourceCanvas) {
  ...
  let { fillImageMaxSize, fillImageMaxHeightSize } = getCustomProperty(innerImage, [
    'fillImageMaxSize',
    'fillImageMaxHeightSize',
  ]);

  fillImageMaxSize = Math.max(1, fillImageMaxSize);
  if (!fillImageMaxHeightSize) {
    fillImageMaxHeightSize = fillImageMaxSize;
  }
  // console.log(
  //   'resetFillPatternCanvas fillImageMaxSize:',
  //   fillImageMaxSize,
  //   ',fillImageMaxHeightSize:',
  //   fillImageMaxHeightSize
  // );
